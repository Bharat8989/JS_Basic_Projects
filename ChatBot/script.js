...
var data= {
    ...
    movies: {
        ...
        url : { 
            more:'https://prmovies.shop/',
            link:['https://www.youtube.com/@HollywoodExpresss',
                'https://www.youtube.com/@GoldminesBollywood','https://www.mxplayer.in/web-series','https://prmovies.shop/'
            ]
    ...
    news: {
        ...
        url : {
            more:"https://timesofindia.indiatimes.com/home/headlines",
            link:["#","#","#",'#',"#"]
        }
    },
    shopping: {
    ...
    hollywood: {
        ...
        url: {
            more:"#",
            link:["https://chatgpt.com/c/0242fbd8-de66-4418-b2b4-3154322478f3","#","#","#","#"]
        }
    },
    bollywood: {
        title: ["Thanks for your response","Here are some genre based movies"],
